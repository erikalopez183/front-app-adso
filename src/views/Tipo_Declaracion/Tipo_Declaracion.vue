<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Tipo_Declaracion'"
      :tituloBoton="'Crear Tipo_Declaracion'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Tipo Declaracion'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formTipo_Declaracion
