<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Clasificacion_Tributaria'"
      :tituloBoton="'Crear Clasificacion_Tributaria'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Clasificacion Tributaria'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formClasificacion_Tributaria  
  ...
  import  formClasificacion_Tributaria from './components/formClasificacion_Tributaria.vue'
