<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Revision_Impuesto'"
      :tituloBoton="'Crear Revision_Impuesto'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Revision de Impuestos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formRevision_Impuesto 
  ...
  import  formRevision_Impuesto from './components/formRevision_Impuesto.vue'
