<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Pago_impuesto'"
      :tituloBoton="'Crear Pago_impuesto'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Pago de Impuestos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
  ...
  import  formPago_Impuesto from './components/formPago_Impuesto.vue'
