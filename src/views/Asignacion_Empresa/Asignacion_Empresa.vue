<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Asignacion_Empresa'"
      :tituloBoton="'Crear Asignacion_Empresa'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Asignacion Empresas'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formAsignacion_Empresa   
  ...
  import  formAsignacion_Empresa from './components/formAsignacion_Empresa.vue'
