<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Tercero'"
      :tituloBoton="'Crear Tercero'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Terceros'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
  ...
  import  formTercero from './components/formTercero.vue'
