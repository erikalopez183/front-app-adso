<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Firma_Impuesto'"
      :tituloBoton="'Crear Firma_Impuesto'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Firma de Impuestos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
  ...
  import  formFirma_Impuesto from './components/formFirma_Impuesto.vue'
