<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Periodicidad_Declaracion'"
      :tituloBoton="'Crear Periodicidad_Declaracion'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Periodicidad de la Declaracion'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formPeriodicidad_Declaracion  
