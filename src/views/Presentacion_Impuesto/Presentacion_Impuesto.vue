<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Presentacion_Impuesto'"
      :tituloBoton="'Crear Presentacion_Impuesto'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Presentacion de Impuestos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formPresentacion_Impuesto 
  ...
  import  formPresentacion_Impuesto from './components/formPresentacion_Impuesto.vue'
