<template>
  <LayoutMain>
    <template #slotLayout>
      <Header 
      :titulo="'Informacion_Impuesto'"
      :tituloBoton="'Crear Informacion_Impuesto'"
      :abrir="abrirFormulario"
      />
      

      <Formulario :titulo="'Gestion de Informacion de Impuestos'" v-model:is-open="mostrarFormulario" :is-edit="editandoFormulario"  >
        <template #slotForm>
          <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <formInformacion_Impuesto
  ...
  import  formInformacion_Impuesto from './components/formInformacion_Impuesto.vue'
